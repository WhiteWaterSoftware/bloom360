        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            <p className="text-ink-light text-lg leading-relaxed">
              ...
              and backed by a dietitian and physical therapist. We&apos;re
              focused on where your health is going, not just where it&apos;s
              been.
            </p>
            <p className="text-ink-light text-lg leading-relaxed">
              No waiting rooms. No runaround. Everything happens virtually, on
              your schedule. But collaboratively, without the silos.
            </p>
          </motion.div>
        </div>
